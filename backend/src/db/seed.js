...
const articles = [
  ...
  },
  {
    ...
    excerpt: "Simple everyday habits can help keep blood pressure under control. Learn what to focus on most.",
    readTime: 4,
    verified: true,
    content: "Hypertension can be managed with daily routines.\n\n- Limit high-salt foods.\n- Take medications on time.\n- Move your body regularly.\n- Reduce stress and prioritize sleep.\n\nTalk with your healthcare provider before changing treatment.",
  },
  {
    ...
    excerpt: "Practical techniques for managing daily stress and reducing anxiety symptoms naturally.",
    readTime: 4,
    verified: true,
    content: "Stress is normal. The goal is to respond in healthy ways.\n\n- Practice slow breathing for a few minutes.\n- Break tasks into smaller steps.\n- Keep a short daily routine.\n- Talk to someone you trust.\n\nIf symptoms are persistent or severe, consider professional support.",
  },
  {
    id: "sleep-for-mood",
    topicId: "mental",
    ...
    excerpt: "Quality sleep supports emotional regulation. Here are easy changes that can help you sleep better.",
    readTime: 3,
    verified: true,
    content: "Good sleep can improve how you feel each day.\n\n- Keep a consistent bedtime.\n- Reduce screen time before sleep.\n- Create a calm sleep environment.\n- Avoid caffeine late in the day.\n\nStart with one change and build gradually.",
  },
  {
    ...
    excerpt: "Tips for maintaining a nutritious diet without breaking the bank. Includes local food suggestions.",
    readTime: 6,
    verified: true,
    content: "Eating well doesn't have to be expensive.\n\n- Choose affordable staples and add vegetables when possible.\n- Plan simple meals for the week.\n- Buy seasonal produce.\n- Limit sugary drinks.\n\nAim for balanced meals and adjust based on your health needs.",
  },
  {
    ...
    excerpt: "A glass of water with your medication helps absorption and keeps you refreshed throughout the day.",
    readTime: 3,
    verified: true,
    content: "Hydration supports overall body function.\n\n- Drink water regularly through the day.\n- Pair hydration with your medication schedule.\n- Watch for signs of dehydration.\n\nIf you have medical conditions affecting fluid intake, follow your clinician's advice.",
  },
  {
    id: "joy-of-movement",
    topicId: "wellness",
    ...
    excerpt: "Simple, enjoyable exercises you can do at home to improve your overall health and mood.",
    readTime: 3,
    verified: true,
    content: "Movement can be simple and still beneficial.\n\nTry:\n- A short walk after meals.\n- Gentle stretching.\n- Light strength exercises.\n\nChoose activities you enjoy so you can stay consistent.",
  },
  {
    ...
    excerpt: "Small daily actions help you feel more in control and support healthier habits over time.",
    readTime: 4,
    verified: true,
    content: "Self-care isn't one big action — it's daily habits.\n\n- Take your medication on schedule.\n- Set reminders for water and movement.\n- Spend a few minutes on breathing or journaling.\n\nConsistency matters more than perfection.",
  },
  {
...
async function main() {
  for (const t of topics) {
    await db.query(
      `INSERT INTO topics (id, name, name_kn)
       VALUES ($1, $2, $3)
       ON CONFLICT (id) DO UPDATE SET name = $2, name_kn = $3`,
      [t.id, t.name, t.nameKn]
    );
  }

  for (const a of articles) {
    await db.query(
      `INSERT INTO articles (id, topic_id, title, title_kn, excerpt, read_time, verified, content)
       VALUES ($1, $2, $3, $4, $5, $6, $7, $8)
       ON CONFLICT (id) DO UPDATE SET
         topic_id = $2, title = $3, title_kn = $4, excerpt = $5,
         read_time = $6, verified = $7, content = $8`,
      [a.id, a.topicId, a.title, a.titleKn, a.excerpt, a.readTime, a.verified, a.content]
    );
  }

  console.log(`Seeded ${topics.length} topics and ${articles.length} articles.`);
}
